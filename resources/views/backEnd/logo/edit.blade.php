...
<section class="content">
                    ...
                    <form action="{{url('/editor/logo/update')}}" method="POST" enctype="multipart/form-data" name="editForm">
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                <label for="logotype" class="mrt-30">Type</label>
                                <select name="logotype" id="logotype" class="form-control{{ $errors->has('logotype') ? ' is-invalid' : '' }}" value="{{ old('logotype') }}">
  ...
  <script type="text/javascript">
      document.forms['editForm'].elements['logotype'].value={{$edit_data->logotype}}
