                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="textarea"  name="description" rows="5" placeholder="Product Descriptions" style="width: 100%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{ $CashOnDelivery->description }}</textarea>
                                </div>
                            </div>
